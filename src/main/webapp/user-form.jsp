			...
			<div class="card-body">
				...
				<caption>
					<h2>
						...
						<c:if test="${user == null}">
						<a class="btn btn-primary" id="t2" href="${pageContext.request.contextPath}">s'authentifier</a>
					<a  class="btn btn-light" id="t"  href="${pageContext.request.contextPath}/login">se connecter</a>
