...
<body  background="e.jpg">
   ...
   <div>
					<a href="${pageContext.request.contextPath}/login" class="btn btn-danger my-2 my-sm-0 top-right">log out</a>
		</div>
    </form>
				...
				<tbody>
					...
					<c:forEach var="quote" items="${listQuote}">
						...
						<tr>
							...
							<td><a href="edit?id=<c:out value='${quote.id}' />">Edit</a>
								&nbsp;&nbsp;&nbsp;&nbsp; <a
								href="delete?id=<c:out value='${quote.id}' />">Delete</a></td>
						</tr>
					</c:forEach>
					<!-- } -->
				</tbody>
